...
export default function Navbar() {
  ...
  return (
    <header className="absolute top-0 left-0 w-full z-50 flex justify-center">
      ...
      {/* NAVBAR */}
      <nav className="mt-6 flex items-center justify-between px-6 py-3 w-[92%] max-w-5xl">

        {/* LOGO */}
        <div className="flex items-center gap-3 cursor-pointer">

          {/* SUN LOGO */}
          <div className="w-9 h-9 text-yellow-400">
      ...
      {/* DROPDOWN */}
      <div
        className={`absolute right-[6%] top-16 w-56 bg-white rounded-lg shadow-lg p-4 transition-all duration-300
